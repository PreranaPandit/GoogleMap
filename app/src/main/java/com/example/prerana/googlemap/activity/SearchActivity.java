...
public class SearchActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void fillArrayListAndSetAdapter() {
        ...
        latitudeLongitudeList.add(new LatitudeLongitude(27.7050028, 85.3269488,"Vijay Smarak"));
        latitudeLongitudeList.add(new LatitudeLongitude(27.7052356, 85.3294158,"Block E of college"));
        latitudeLongitudeList.add(new LatitudeLongitude(-33.7319287, 151.1414574,"Pymble Sydney"));
        latitudeLongitudeList.add(new LatitudeLongitude(27.6634881,84.4187542, "BP KOoirala"));
        latitudeLongitudeList.add(new LatitudeLongitude(28.2355766,84.3748961, "Jana Bikash school, Besisahar - Chame Sadak, Besisahar"));
